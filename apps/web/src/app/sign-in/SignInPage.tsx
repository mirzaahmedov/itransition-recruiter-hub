...
const SignInPage = () => {
  ...
  return (
    <div className="h-full grid place-content-center">
      <div className="card bg-base-200 p-10 flex flex-col gap-5">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-5">
          ...
          <div className="relative">
            ...
            <button onClick={togglePasswordHidden} className="absolute top-1 right-2 btn btn-ghost btn-sm btn-circle">
              {isPasswordHidden ? <EyeIcon className="size-5" /> : <EyeSlashIcon className="size-5" />}
            </button>
          </div>
